...
class Params:
	...
	def add_columns(self,num_robots):
		for i in range(num_robots):
			self.data_columns_name.append('h_'+str(i))
			self.data_columns_name.append('tr_'+str(i))
			self.data_columns_name.append('Response_'+str(i))
			self.data_columns_name.append('rt_step'+str(i))
		# self.data_columns_name.append('mem_size')
		# self.data_columns_name.append('thr_step')
		
		self.data_columns_name.append('Dq')
		self.data_columns_name.append('$\mu_{q_1}$')
		self.data_columns_name.append('$\mu_{q_2}$')
		self.data_columns_name.append('$\sigma_{q_1}$')
		self.data_columns_name.append('$\sigma_{q_2}$')
		self.data_columns_name.append('n')
